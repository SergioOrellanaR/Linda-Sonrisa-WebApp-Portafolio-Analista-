...
namespace PortafolioNet.Business
{
    public class MailSender
    {
        ...
        Attachment Archivo;
        string DE = "lindasonrisawebpage@gmail.com"; //nuestro usuario de smtp
        string PASS = "portafolio2018"; //nuestro password de smtp
        ...
        public MailSender(string FROM, string Para, string Mensaje, string Asunto, Attachment attachment)
        {
            From = FROM;
            To = Para;
            Message = Mensaje;
