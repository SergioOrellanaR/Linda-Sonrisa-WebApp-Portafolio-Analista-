    ...
    <div class="header-content clearfix"> <a class="logo" href="Index.aspx">LINDA SONRISA</a>
      <nav class="navigation" role="navigation">
        <ul class="primary-nav">
          ...
          <li><a href="LoginClose.aspx"><asp:Label ID="lblCerrarSesion" runat="server" Text=""></asp:Label></a></li>
        </ul>
      </nav>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 col-md-offset-2 conForm">
        ...
        <div id="message"></div>
              <asp:TextBox ID="txUser" class="col-xs-12 col-sm-12 col-md-12 col-lg-12 noMarr" type="text" placeholder="Usuario" runat="server"></asp:TextBox>
              ...
              <asp:Button ID="submit" runat="server" Text="Registrarme" class="submitBnt"   />
